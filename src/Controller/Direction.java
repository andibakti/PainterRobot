...
public class Direction {
    ...
    public double[] getDegree(ArrayList<double[]> allCrd,int n ){
        ...
        //initialize current coordinate x and y
        double x=curCrd[0];
        double y=curCrd[1];
        
        //initialize next coordinate x and y
        double xn=nxtCrd[0];
        double yn=nxtCrd[1];
        
        //initialize last coordinate x and y
        double xl=lstCrd[0];
        double yl=lstCrd[1];
          
        Double angle;
        
        //using trigonometry to calculate the angle of the path
